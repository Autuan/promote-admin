...
public class TabRedPinExample {
    ...
    public TabRedPinExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public TabRedPinExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public TabRedPinExample page(Integer page, Integer pageSize) {
