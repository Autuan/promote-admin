...
public class TabSalesmanTaskExample {
    ...
    public TabSalesmanTaskExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public TabSalesmanTaskExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public TabSalesmanTaskExample page(Integer page, Integer pageSize) {
