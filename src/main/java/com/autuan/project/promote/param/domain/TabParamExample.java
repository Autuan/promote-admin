...
public class TabParamExample {
    ...
    public TabParamExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public TabParamExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public TabParamExample page(Integer page, Integer pageSize) {
