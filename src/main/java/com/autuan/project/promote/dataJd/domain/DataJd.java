...
public class DataJd extends BaseEntity
{
    ...
    /** 打卡是否有效 0-否 1-是 */
    @Excel(name = "打卡是否有效",combo = "否,是")
    private Integer checkStatus;
    /** 打卡失效原因 */
    @Excel(name = "打卡失效原因")
    private String checkReason;
    /** 用户参与京东pin（脱敏） */
    @Excel(name = "用户参与京东pin")
    ...
    /** 白条开通方式 0-无 1-普通开白条 2-小金库白条 3-新手礼包 */
    @Excel(name = "白条开通方式",combo = "普通开白条,小金库白条,新手礼包")
    ...
    /** 白条开通首单是否同日 0-否 1-是 */
    @Excel(name = "白条开通首单是否同日",combo = "否,是")
    ...
    @Excel(name = "新手礼包操作结果",combo = "fail,success")
    private Long newbiePackageResult;
    /** 金条贷款订单号 */
    @Excel(name = "金条贷款订单号")
    private String jdGoldOrderNo;
    /** 金条是否首次贷款 0:否 1:是 */
    @Excel(name = "金条是否首次贷款",combo = "否,是")
